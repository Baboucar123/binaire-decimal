...
MaFenetre::MaFenetre(QWidget *parent) : QDialog(parent)
{
   ...
   choixConversion->addItem(QString::fromUtf8("Base2 -> Base 10"));
   choixConversion->addItem(QString::fromUtf8("Base10 -> Base 2"));
...
void MaFenetre::convertir()
{
   ...
   case Base10_Base2:
   {
       int base10 = nombre.toInt(&ok);
       if (ok)
       {
           resultat->setText(QString::number(base10, 2));
       }
       else
       {
   ...
   case Base2_Base10:
   {
       ...
       if (ok)
       {
           resultat->setText(QString::number(base2));
       }
       else
       {
           resultat->setText(QString::fromUtf8("Erreur"));
...
void MaFenetre::afficherUnite()
{
   ...
   case Base10_Base2:
       ...
       break;
   case Base2_Base10:
       unite->setText(QString::fromUtf8(" (base 10)"));
       break;
   }
}
